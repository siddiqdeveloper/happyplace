...
@Component({
  selector: 'app-bottom-banner-image',
  templateUrl: './bottom-banner-image.component.html',
  styleUrls: ['./bottom-banner-image.component.css']
})
export class BottomBannerImageComponent implements OnInit {
  ...
  imageUpdateBanner(imageFile) {
      ...
      this.apiService.postData(formData, 'imageUpdateBottomBanner').subscribe(data => {
      if (data.error === false) {
          this.toastr.success(data.message);
          this.router.navigate(['/bottom-banner']);
      } else {
