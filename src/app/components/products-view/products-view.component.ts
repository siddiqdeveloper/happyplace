...
export class ProductsViewComponent implements OnInit {
  ...
  subcategory_id: any;
    ...
    constructor(public ar:ActivatedRoute,  private apiService: ApiService, private toastr: ToastrService, private imageService: ImageService, private formBuilder: FormBuilder) { }
