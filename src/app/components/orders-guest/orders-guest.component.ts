...
@Component({
    selector: 'app-orders',
    templateUrl: './orders-guest.component.html',
    styleUrls: ['./orders-guest.component.css']
})
export class OrdersGuestComponent implements OnInit {
    loading: boolean;
    ...
    listAllOrders() {
        this.loading = true;
        this.apiService.getData('listAllOrdersGuest').subscribe((data) => {
