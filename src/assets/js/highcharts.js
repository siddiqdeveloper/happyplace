...
$(function(e) {
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#8543f6', '#fb8d34', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	/* ---hightchart4----*/
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#ecb403', '#64E572', '#24CBE5', '#8543f6', '#fb8d34'],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#fb8d34', '#8543f6', '#ff5c75'],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	var chart = Highcharts.chart('highchart7', {
		...
		colors: ['#8543f6', '#fb8d34', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
		series: [{
			type: 'column',
			colorByPoint: true,
